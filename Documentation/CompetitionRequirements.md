...
| 6 | Output is minimum signed 16-bit | `mac_pair.v` accumulator is 20-bit signed (exceeds the minimum; see `PerformanceResults.md` for the overflow-proof-by-construction justification) |
...
|---|---|
| Correctness | Golden-model vs RTL simulation comparison pipeline (`Python/verify.py`), 900/900 on the demo case |
